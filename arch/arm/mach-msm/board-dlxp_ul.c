...
struct tpa6185_platform_data tpa6185_data={
         .gpio_tpa6185_spk_en = PM8921_GPIO_PM_TO_SYS(AUD_HP_EN),
...
static struct platform_device dlxp_ul_android_pmem_device = {
	.name = "android_pmem",
	.id = 0,
...
static struct platform_device dlxp_ul_android_pmem_adsp_device = {
	.name = "android_pmem",
	.id = 2,
	.dev = { .platform_data = &android_pmem_adsp_pdata },
};

static struct android_pmem_platform_data dlxp_ul_android_pmem_audio_pdata = {
	.name = "pmem_audio",
	.allocator_type = PMEM_ALLOCATORTYPE_BITMAP,
	.cached = 0,
	.memory_type = MEMTYPE_EBI1,
...
static struct msm_rtb_platform_data dlxp_ul_rtb_pdata = {
...
static int __init msm_rtb_set_buffer_size(char *p)
{
       ...
       s = memparse(p, NULL);
       dlxp_ul_rtb_pdata.size = ALIGN(s, SZ_4K);
       return 0;
}
early_param("msm_rtb_size", msm_rtb_set_buffer_size);


static struct platform_device dlxp_ul_rtb_device = {
       .name           = "msm_rtb",
       .id             = -1,
       .dev            = {
               .platform_data = &dlxp_ul_rtb_pdata,
       },
};
#endif
...
static int dlxp_ul_paddr_to_memtype(unsigned int paddr)
{
	return MEMTYPE_EBI1;
}
...
#ifdef CONFIG_MSM_MULTIMEDIA_USE_ION
static struct ion_cp_heap_pdata cp_mm_dlxp_ul_ion_pdata = {
...
static struct ion_co_heap_pdata fw_co_dlxp_ul_ion_pdata = {
...
static struct ion_platform_data ion_pdata = {
	...
	.heaps = {
...
#ifdef CONFIG_MSM_MULTIMEDIA_USE_ION
		{
			...
			.extra_data = (void *) &cp_mm_dlxp_ul_ion_pdata,
		},
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &fw_co_dlxp_ul_ion_pdata,
		},
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &cp_mfc_dlxp_ul_ion_pdata,
		},
#ifndef CONFIG_MSM_IOMMU
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &co_dlxp_ul_ion_pdata,
		},
#endif
		{
...
static struct platform_device dlxp_ul_ion_dev = {
	.name = "ion-msm",
	.id = 1,
...
static struct platform_device dlxp_ul_rfkill = {
	.name = "dlxp_ul_rfkill",
	.id = -1,
};
#endif
...
{
	dlxp_ul_mdp_writeback(apq8064_reserve_table);
}

static void __init dlxp_ul_calculate_reserve_sizes(void)
{
	size_pmem_devices();
	reserve_pmem_memory();
	reserve_ion_memory();
...
static struct reserve_info dlxp_ul_reserve_info __initdata = {
	.memtype_reserve_table = apq8064_reserve_table,
	.calculate_reserve_sizes = dlxp_ul_calculate_reserve_sizes,
	.reserve_fixed_area = apq8064_reserve_fixed_area,
	.paddr_to_memtype = dlxp_ul_paddr_to_memtype,
};

static int dlxp_ul_memory_bank_size(void)
{
	return 1<<29;
}
...
static void __init locate_unstable_memory(void)
{
	...
	bank_size = dlxp_ul_memory_bank_size();
	...
	dlxp_ul_reserve_info.low_unstable_address = mb->start -
					MIN_MEMORY_BLOCK_SIZE + mb->size;
	dlxp_ul_reserve_info.max_unstable_size = MIN_MEMORY_BLOCK_SIZE;

	dlxp_ul_reserve_info.bank_size = bank_size;
	pr_info("low unstable address %lx max size %lx bank size %lx\n",
		dlxp_ul_reserve_info.low_unstable_address,
		dlxp_ul_reserve_info.max_unstable_size,
		dlxp_ul_reserve_info.bank_size);
	return;
#endif
no_dmm:
	dlxp_ul_reserve_info.low_unstable_address = high;
	dlxp_ul_reserve_info.max_unstable_size = 0;
}

int __init parse_tag_memsize(const struct tag *tags);
static unsigned int mem_size_mb;

static void __init dlxp_ul_reserve(void)
{
	if (mem_size_mb == 64)
		return;
...
static void __init dlxp_ul_early_reserve(void)
{
	reserve_info = &dlxp_ul_reserve_info;
...
static void dlxp_ul_usb_dpdn_switch(int path)
{
	switch (path) {
	case PATH_USB:
...
static T_MHL_PLATFORM_DATA mhl_sii9234_device_data = {
	...
	.ci2ca = 0,
#ifdef CONFIG_FB_MSM_HDMI_MHL
	.mhl_usb_switch		= dlxp_ul_usb_dpdn_switch,
...
static void dlxp_ul_config_usb_id_gpios(bool output)
{
	int rc;
...
static struct cable_detect_platform_data cable_detect_pdata = {
       ...
       .usb_id_pin_gpio        = USB1_HS_ID_GPIO,
       .get_adc_cb             = dlxp_ul_get_usbid_adc,
       .config_usb_id_gpios    = dlxp_ul_config_usb_id_gpios,
#ifdef CONFIG_FB_MSM_HDMI_MHL
       .mhl_1v2_power = mhl_sii9234_1v2_power,
       .usb_dpdn_switch        = dlxp_ul_usb_dpdn_switch,
#endif
};
...
void dlxp_ul_cable_detect_register(void)
{
	int rc;
...
void dlxp_ul_pm8xxx_adc_device_register(void)
{
	pr_info("%s: Register PM8XXX ADC device. rev: %d\n",
		__func__, system_rev);
	dlxp_ul_cable_detect_register();
}

void dlxp_ul_add_usb_devices(void)
{
...
static struct wcd9xxx_pdata dlxp_ul_tabla_platform_data = {
...
static struct slim_device dlxp_ul_slim_tabla = {
	.name = "tabla-slim",
	.e_addr = {0, 1, 0x10, 0, 0x17, 2},
	.dev = {
		.platform_data = &dlxp_ul_tabla_platform_data,
	},
};

static struct wcd9xxx_pdata dlxp_ul_tabla20_platform_data = {
	.slimbus_slave_device = {
		.name = "tabla-slave",
...
static struct slim_device dlxp_ul_slim_tabla20 = {
	.name = "tabla2x-slim",
	.e_addr = {0, 1, 0x60, 0, 0x17, 2},
	.dev = {
		.platform_data = &dlxp_ul_tabla20_platform_data,
	},
};
...
static void __init dlxp_ul_map_io(void)
{
...
static void __init dlxp_ul_init_irq(void)
{
...
static struct platform_device msm8064_device_saw_regulator_core0 = {
	...
	.id	= 0,
	.dev	= {
		.platform_data = &dlxp_ul_saw_regulator_pdata_8921_s5,
	},
};
...
static struct platform_device msm8064_device_saw_regulator_core1 = {
	...
	.id	= 1,
	.dev	= {
		.platform_data = &dlxp_ul_saw_regulator_pdata_8921_s6,
	},
};
...
static struct platform_device msm8064_device_saw_regulator_core2 = {
	...
	.id	= 2,
	.dev	= {
		.platform_data = &dlxp_ul_saw_regulator_pdata_8821_s0,
	},
};
...
static struct platform_device msm8064_device_saw_regulator_core3 = {
	...
	.id	= 3,
	.dev	= {
		.platform_data = &dlxp_ul_saw_regulator_pdata_8821_s1,
...
static void __init dlxp_ul_init_buses(void)
{
...
static struct platform_device dlxp_ul_device_ext_5v_vreg __devinitdata = {
	.name	= GPIO_REGULATOR_DEV_NAME,
	.id	= PM8921_MPP_PM_TO_SYS(7),
	.dev	= {
		.platform_data
			= &dlxp_ul_gpio_regulator_pdata[GPIO_VREG_ID_EXT_5V],
	},
};

static struct platform_device dlxp_ul_device_ext_mpp8_vreg __devinitdata = {
	.name	= GPIO_REGULATOR_DEV_NAME,
	.id	= PM8921_MPP_PM_TO_SYS(8),
	.dev	= {
		.platform_data
			= &dlxp_ul_gpio_regulator_pdata[GPIO_VREG_ID_EXT_MPP8],
	},
};

static struct platform_device dlxp_ul_device_ext_ts_sw_vreg __devinitdata = {
	.name	= GPIO_REGULATOR_DEV_NAME,
	.id	= PM8921_GPIO_PM_TO_SYS(23),
	.dev	= {
		.platform_data
			= &dlxp_ul_gpio_regulator_pdata[GPIO_VREG_ID_EXT_TS_SW],
	},
};

static struct platform_device dlxp_ul_device_rpm_regulator __devinitdata = {
	.name	= "rpm-regulator",
	.id	= -1,
	.dev	= {
		.platform_data = &dlxp_ul_rpm_regulator_pdata,
	},
};
...
static mhl_driving_params dlxp_ul_driving_params[] = {
...
static struct msm_hdmi_platform_data hdmi_msm_data = {
	...
	.driving_params = dlxp_ul_driving_params,
	.dirving_params_count = ARRAY_SIZE(dlxp_ul_driving_params),
};
...
static struct platform_device *common_devices[] __initdata = {
	...
	&msm_device_uart_dm4,
#endif
	&dlxp_ul_device_ext_5v_vreg,
	&dlxp_ul_device_ext_mpp8_vreg,
	&dlxp_ul_device_ext_ts_sw_vreg,
...
#ifdef CONFIG_ANDROID_PMEM
#ifndef CONFIG_MSM_MULTIMEDIA_USE_ION
	&dlxp_ul_android_pmem_device,
	&dlxp_ul_android_pmem_adsp_device,
	&dlxp_ul_android_pmem_audio_device,
#endif 
#endif 
#ifdef CONFIG_ION_MSM
	&dlxp_ul_ion_dev,
...
static struct msm_spi_platform_data dlxp_ul_qup_spi_gsbi5_pdata = {
...
static struct slim_boardinfo dlxp_ul_slim_devices[] = {
	{
		.bus_num = 1,
		.slim_slave = &dlxp_ul_slim_tabla,
	},
	{
		.bus_num = 1,
		.slim_slave = &dlxp_ul_slim_tabla20,
	},
	
};

static struct msm_i2c_platform_data dlxp_ul_i2c_qup_gsbi1_pdata = {
	.clk_freq = 100000,
...
static struct msm_i2c_platform_data dlxp_ul_i2c_qup_gsbi3_pdata = {
	.clk_freq = 384000,
	.src_clk_rate = 24000000,
...
static struct msm_i2c_platform_data dlxp_ul_i2c_qup_gsbi4_pdata = {
	.clk_freq = 384000,
	.src_clk_rate = 24000000,
	.share_uart_flag = 1,
};
...
#endif
static struct cir_platform_data dlxp_ul_cir_gsbi3_pdata = {
...
static void __init dlxp_ul_i2c_init(void)
{
	void __iomem *gsbi_mem;

	apq8064_device_qup_i2c_gsbi1.dev.platform_data =
					&dlxp_ul_i2c_qup_gsbi1_pdata;
	gsbi_mem = ioremap_nocache(MSM_GSBI1_PHYS, 4);
	writel_relaxed(GSBI_DUAL_MODE_CODE, gsbi_mem);
	/* Ensure protocol code is written before proceeding */
	wmb();
	iounmap(gsbi_mem);
	dlxp_ul_i2c_qup_gsbi1_pdata.use_gsbi_shared_mode = 1;

	apq8064_device_qup_i2c_gsbi2.dev.platform_data =
					&apq8064_i2c_qup_gsbi2_pdata;
	apq8064_device_qup_i2c_gsbi3.dev.platform_data =
					&dlxp_ul_i2c_qup_gsbi3_pdata;
	apq8064_device_qup_i2c_gsbi4.dev.platform_data =
					&dlxp_ul_i2c_qup_gsbi4_pdata;
}

static void __init dlxp_ul_hp_en_det(void)
{
	if (system_rev >= XC) {
		
		rt5501_data.gpio_rt5501_spk_en = PM8921_GPIO_PM_TO_SYS(AUD_HP_EN_XC);
		tpa6185_data.gpio_tpa6185_spk_en = PM8921_GPIO_PM_TO_SYS(AUD_HP_EN_XC);
	}
}
...
static void __init dlxp_ul_init_dsps(void)
{
...
static int dlxp_ul_mpu3050_sensor_power_LPM(int on)
{
	int rc = 0;
...
static struct mpu3050_platform_data mpu3050_data_XAB = {
	...
	.power_LPM = dlxp_ul_mpu3050_sensor_power_LPM,
};
...
static struct i2c_registry dlxp_ul_i2c_devices[] __initdata = {
	{
		I2C_SURF | I2C_FFA,
...
static void __init register_i2c_devices(void)
{
	...
	for (i = 0; i < ARRAY_SIZE(dlxp_ul_i2c_devices); ++i) {
		if (dlxp_ul_i2c_devices[i].machs & mach_mask) {
			i2c_register_board_info(dlxp_ul_i2c_devices[i].bus,
						dlxp_ul_i2c_devices[i].info,
						dlxp_ul_i2c_devices[i].len);
		}
	}
...
static void __init dlxp_ul_cir_init(void)
{
	...
	apq8064_device_uart_gsbi3.dev.platform_data =
					&dlxp_ul_cir_gsbi3_pdata;
}
#endif

static void __init dlxp_ul_common_init(void)
{
	int rc = 0;
	...
	slim_register_board_info(dlxp_ul_slim_devices,
		ARRAY_SIZE(dlxp_ul_slim_devices));
	dlxp_ul_init_dsps();
...
static void __init dlxp_ul_allocate_memory_regions(void)
{
	dlxp_ul_allocate_fb_region();
}

static void __init dlxp_ul_cdp_init(void)
{
...
static void __init dlxp_ul_fixup(struct tag *tags, char **cmdline, struct meminfo *mi)
{
	...
	printk(KERN_INFO "DLXP_UL_fixup:skuid=0x%x\n", skuid);
}

MACHINE_START(DLXP_UL, "UNKNOWN")
	.fixup = dlxp_ul_fixup,
	.map_io = dlxp_ul_map_io,
	.reserve = dlxp_ul_reserve,
	.init_irq = dlxp_ul_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = dlxp_ul_cdp_init,
	.init_early = dlxp_ul_allocate_memory_regions,
	.init_very_early = dlxp_ul_early_reserve,
	.restart = msm_restart,
MACHINE_END

MACHINE_START(DLXP_U, "UNKNOWN")
	.fixup = dlxp_ul_fixup,
	.map_io = dlxp_ul_map_io,
	.reserve = dlxp_ul_reserve,
	.init_irq = dlxp_ul_init_irq,
